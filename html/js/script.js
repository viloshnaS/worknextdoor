      ...
      result_arr.forEach(function(hub) {
       ...
       display_string += "<div class='center block clear' style='width: max-content;'>";
         ...
         hub.spaces.forEach(function(space) {
          ...
          display_string += " <div class=' block' style='margin-left: 20px'>Add more spaces<a href='hostSpace.html?hub_id=" + hub.hub_id + "' class='material-icons' style='margin-left: 10px'>add</a></div>";
...
function toggleHubList(tagg){
  jQuery(tagg).parent().siblings('div').slideToggle('slow');
}
