...
echo createHub($name,$description,$user_id,$latitude,$longitude,$address,$parking,$kitchen,$printer_scanner,$heater,$aircon,$wifi,$picture,$weekends,$public_holidays);
...
function createHub($name,$description,$user_id,$latitude,$longitude,$address,$parking,$kitchen,$printer_scanner,$heater,$aircon,$wifi,$picture,$weekends,$public_holidays){
	global $connection;
	...
	VALUES('$name','$description',$user_id,$latitude,$longitude,'$address',$parking,$kitchen,$printer_scanner,$heater,$aircon,$wifi,'$picture',$weekends,$public_holidays)";
